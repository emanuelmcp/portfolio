...
useSeoMeta({
  title: 'Inicio',
  description: 'Emanuel Carrero - Freelancer fullstack',
})
</script>

<template>
  <ULandingHero orientation="horizontal" :ui="{ wrapper: 'md:py-20' }"
    ...
    title="Experto en Desarrollo Fullstack" align="left" :links="[
      { label: 'Sobre mi', icon: '', color: 'green', size: 'lg', to: '/about' },
      { label: 'Contáctame', color: 'gray', size: 'lg', trailingIcon: 'i-heroicons-arrow-right-20-solid', to: '/contact' }
    ]">
    <div class="hidden lg:block px-4">
      <NuxtImg height="592" width="498" alt="Emanuel Carrero" format="webp" src="emanuel-carrero.webp" />
    </div>
  </ULandingHero>
  <UPage>
    <TechSkills />
